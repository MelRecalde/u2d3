...
for (let i = 0; i < starWarsCharacters.length; i++) {
  const element = starWarsCharacters[i].eye_color;
  switch (element) {
    case "blue":
...
/* ESERCIZIO 7
  ...
  Una volta fatto, modifica la massa di qualche charactersNameso dell'equipaggio e vedi se riesci ad ottenere un messaggio diverso.
*/
...
/* --EXTRA-- ESERCIZIO 9
  Utilizzando gli charactersNamesi presenti nell'array "femaleCharacters" rimuovi dall'array "charactersNames" le stringhe corrispondenti a personaggi con lo stesso nome.
  Una volta fatto crea un console.log per controllare la proprietà length di "charactersNames" prima e dopo l'operazione.
*/

/* --EXTRA-- ESERCIZIO 10
  Crea una funzionalità che selezioni un charactersNameso casuale dall'array "starWarsCharacters" e ne stampi in console le proprietà in modo discorsivo (a tuo piacimento).
*/
